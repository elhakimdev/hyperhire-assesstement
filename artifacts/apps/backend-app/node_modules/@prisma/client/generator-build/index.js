...
var require_package2 = __commonJS({
  "package.json"(exports2, module2) {
    module2.exports = {
      name: "@prisma/client",
      version: "6.5.0-integration-push-zsmplqopwokk.1",
...
async function getDefaultOutdir(outputDir) {
  if (outputDir.endsWith(import_path5.default.normalize("node_modules/@prisma/client"))) {
...
async function getGenerationDirs({
  ...
  const normalizedOutputDir = import_path5.default.normalize(outputDir);
