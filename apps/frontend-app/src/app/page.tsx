...
export default function Index() {
  ...
  return (
    <div>
      <div className="w-full h-screen items-center justify-center flex flex-row p-[24px] bg-black" onMouseMove={handleMouseMove}>
        <div
          className="absolute w-[500px] h-[500px] bg-white opacity-20 rounded-full pointer-events-none transition-all duration-300 ease-out"
          style={{
            top: mousePosition.y - 250, // Centering effect
            left: mousePosition.x - 250,
            filter: "blur(50px)",
            transform: isHoveringLogo ? "scale(1.2)" : "scale(1)", // Smoothly enlarges
            transition: "transform 0.5s ease-in-out, background 0.5s ease-in-out", // Smoother transition
            background: isHoveringLogo
            ? "radial-gradient(circle, rgba(255,255,255,0.8) 50%, rgba(255,255,255,0) 80%)"
            : "radial-gradient(circle, rgba(255,255,255,0.3) 10%, rgba(255,255,255,0) 60%)",
          }}
        />
        <Link href={'/menu'}
        ...
        >
          <svg width="560" height="176" viewBox="0 0 70 22" fill="none" xmlns="http://www.w3.org/2000/svg"
            className={`transition-all ease-in-out duration-500 ${
              isHoveringLogo ? "opacity-100 drop-shadow-[0_0_2px_rgba(255,255,255,0.8)]" : "opacity-10"
            }`}
          >
            <g clipPath="url(#clip0_9123_121)">
            ...
            <mask id="mask0_9123_121" style={{ maskType: "luminance" }} maskUnits="userSpaceOnUse" x="0" y="0" width="70" height="22">
            <path d="M0 0.429504H70V21.5709H0V0.429504Z" fill="white"/>
            </mask>
            <g mask="url(#mask0_9123_121)">
